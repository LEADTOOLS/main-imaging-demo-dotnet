namespace MainDemo
{
   partial class UnderlayDialog
   {
      ...
      {
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(UnderlayDialog));
         ...
         // _rbTile
         // 
         resources.ApplyResources(this._rbTile, "_rbTile");
         this._rbTile.Name = "_rbTile";
         this._rbTile.TabStop = true;
         this._rbTile.UseVisualStyleBackColor = true;
         // 
         // _rbStretch
         // 
         resources.ApplyResources(this._rbStretch, "_rbStretch");
         this._rbStretch.Name = "_rbStretch";
         this._rbStretch.TabStop = true;
         this._rbStretch.UseVisualStyleBackColor = true;
         // 
         // UnderlayDialog
         // 
