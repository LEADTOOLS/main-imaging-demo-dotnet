namespace MainDemo
{
   partial class GammaAdjustmentDialog
   {
      /// <summary>
      ...
      {
         System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(GammaAdjustmentDialog));
         ...
         this._numValue.Value = new decimal(new int[] {
            10,
            0,
            0,
            0});
         ...
         this.Name = "GammaAdjustmentDialog";
         this.ShowIcon = false;
         this.ShowInTaskbar = false;
         this.Load += new System.EventHandler(this.GammaAdjustmentDialog_Load);
